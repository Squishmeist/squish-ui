    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-8 sm:py-12">
      <div className="mb-10">
        ...
        <p className="text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
          Use this setup for components in <code>components/mobile</code>.
        </p>
      </div>
...
export function useMobileTheme(): MobileTheme {
  return useColorScheme() === "dark" ? "dark" : "light";
          ...
          filename="components/mobile/use-mobile-theme.ts"
        />
        <Step
          number="4"
...
const styles = StyleSheet.create({
  card: { borderRadius: 8, padding: 16 },
          ...
          filename="components/mobile/example/example.tsx"
        />
      </ol>
    </div>
  );
